...
import { getCurrentProfile, deleteAccount, photoUpload } from '../../actions/profileActions';
...
class Dashboard extends Component {
    ...
    render() {
        ...
        return (
            <div className="dashboard" style={{ marginBottom: '1000px', marginLeft: '18px' }}>
                <div className="row" >
                    <div className="fb-profile col-md-9" style={{ marginLeft: '20px' }}>
                        <img align="left" style={boxStyle} className="fb-image-lg" src="https://i.ibb.co/8Xx6yD8/7588568-7366b7523095e196beaf0434b81e8e81189b385f.jpg" alt="Profile example" />
...
export default connect(mapStateToProps, { getCurrentProfile, deleteAccount, photoUpload })(Dashboard);
