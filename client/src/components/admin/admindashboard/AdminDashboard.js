          ...
          <div className="row adminpanel">
            <div className="card text-center" style={{ width: "400px" }}>
              <div className="card-body ">
                ...
                <Link to="/admin/createCourse" className="btn btn-primary">
                  Click Here
                </Link>
              </div>
            </div>
            ...
            <div className="card text-center" style={{ width: "400px" }}>
              <div className="card-body ">
                ...
                <Link to="/admin/viewRegistrations" className="btn btn-primary">
                  Click Here
                </Link>
              </div>
            </div>
            ...
            <div className="card text-center" style={{ width: "400px" }}>
              <div className="card-body ">
                ...
                <Link to="/admin/campusambassador" className="btn btn-primary">
                  Click Here
                </Link>
              </div>
            </div>
